...
7. Use the repository sibling `skills/evaluate-skill-quality` when present; otherwise use the installed `evaluate-skill-quality`. For a public release, do not publish a Skill rated C or D; resolve P0 items and rerun the evaluation. If neither evaluator is available, stop before public release and report the missing gate.
